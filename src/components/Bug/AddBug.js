          ...
          <div className="container">
            ...
            <div className="modal-body">
              <div className="mb-3">
                ...
                <input type="text" className="form-control" id="bug-summary" placeholder="Summary of the New Bug" />
              </div>
              <div className="mb-3">
                <label htmlFor="bug-desc" className="form-label float-start fs-5">Description</label>
                <textarea className="form-control" id="bug-desc" rows="3" placeholder="Detailed description of the New Bug"></textarea>
              </div>
              <div className="row g-3 align-items-center">
                ...
                <div className="col-auto">
                  <input type="text" id="bug-tag" className="form-control"/>
                </div>
